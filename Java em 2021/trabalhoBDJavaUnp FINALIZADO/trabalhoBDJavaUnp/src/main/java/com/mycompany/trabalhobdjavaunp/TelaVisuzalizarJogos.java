 ...
 * @author Alvar
 */
public class TelaVisuzalizarJogos extends javax.swing.JFrame {

    /**
     * Creates new form TelaVisuzalizarJogos
     */
    public TelaVisuzalizarJogos() {
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) jtJogos.getModel();
        JogosDAO jdao = new JogosDAO();
        
        for (Jogo j: jdao.read(TelaLoginTrabalho.idUsuario)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisuzalizarJogos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVisuzalizarJogos().setVisible(true);
            }
        });
    }
